...
public class findAndHoldSeatsTest {
	...
	public void testFindAndHoldSeats() {
		...
		String expected ="SeatHold [seatHoldId=5465, customerEmail=a@c.com, confirmCode=null, levelNum=4, SeatList=[Seat [rowNum=14, colNum=0, isReserved=false, isHold=true], Seat [rowNum=14, colNum=1, isReserved=false, isHold=true]]]";
